...
public class CuentaBancariaService {
    ...
    public CuentaBancaria crearCuenta(Tarjeta tarjeta, Cliente cliente, TarjetaService tarjetaService, CuentaBancaria cuentaBancaria){
        String clave;
        String confirmClave;
        ...
        cuentaBancaria.setTarjeta(tarjetaService.crearTarjeta(tarjeta));
